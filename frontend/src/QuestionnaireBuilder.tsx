...
const QuestionnaireBuilder: React.FC = () => {
  ...
  const questionTypes = [
    ...
    { value: 'checkbox', label: { en: 'Multiple Choice (Select Multiple)', sq: 'Zgjedhje e Shumëfishtë (Zgjidh Shumë)', sr: 'Вишеструки избор (Изаберите више)' }, icon: '☑️' },
    { value: 'radio', label: { en: 'Single Choice', sq: 'Zgjedhje e Vetme', sr: 'Једноструки избор' }, icon: '⚪' },
